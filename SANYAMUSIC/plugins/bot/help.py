...
from SANYAMUSIC.utils.inline.help import help_back_markup, private_help_panel, help_pannel
from config import BANNED_USERS, START_IMG_URL, SUPPORT_CHAT
from strings import get_string
from SANYAMUSIC.utils.stuffs.helper import Helper
from SANYAMUSIC.utils.inline.help import help_pannel
...
@languageCB
async def help_page_handler(client, callback_query: CallbackQuery, _):
    page = int(callback_query.matches[0].group(1))
    keyboard = help_pannel(_, page)
    if not keyboard:
