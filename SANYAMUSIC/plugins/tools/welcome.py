...
"""
            ...
            # AUTO-DELETE: Task starts in background, message deletes after 30 seconds (30 seconds)
            asyncio.create_task(auto_delete_msg(msg, 30))

        except Exception as e:
            LOGGER.error(e)

__module__ = "Welcome"
__help__ = """**Welcome Module:**

✧ `/welcome [on/off]` : Enable or disable welcome messages in the group."""
